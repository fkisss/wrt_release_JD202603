...
CUPS_MK="$BASE_PATH/../$BUILD_DIR/feeds/small8/cups/Makefile"
if [ -f "$CUPS_MK" ]; then
    sed -i '/LIBS=.*-ljpeg/a\\t\tac_cv_header_avahi_client_client_h=no \\\n\t\tac_cv_lib_avahi_client_avahi_client_new=no \\' "$CUPS_MK"
